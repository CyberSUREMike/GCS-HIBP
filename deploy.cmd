...
IF DEFINED KUDU_SELECT_PYTHON_VERSION_CMD (
  ...
  SET PYTHON_RUNTIME=python-3.6.4.4
  SET PYTHON_VER=3.6.4.4
  SET PYTHON_EXE=%SYSTEMDRIVE%\python364x64\python.exe
...
env\scripts\pip2.7.exe install -r requirements.txt 
